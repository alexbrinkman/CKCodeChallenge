...
Welcome Commerce Kitchen, I hope you enjoy what I've put together.

# Assumptions
* Only ever want 4 weeks of movie projections, and only 5 movies.

# Improvements
* Bring in and verify data before clearing movie database.
...
* N+1 queries.
* Moving API calls to a background worker.
